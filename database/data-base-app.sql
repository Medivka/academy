...
INSERT INTO `academy`.`b_and_d_table`(`id_d`, `id_b`)VALUES ('1', '1');
INSERT INTO `academy`.`b_and_d_table`(`id_d`, `id_b`)VALUES ('1', '2');
INSERT INTO `academy`.`b_and_d_table`(`id_d`, `id_b`)VALUES ('2', '3');
INSERT INTO `academy`.`b_and_d_table`(`id_d`, `id_b`)VALUES ('2', '1');
INSERT INTO `academy`.`b_and_d_table`(`id_d`, `id_b`)VALUES ('1', '3');
INSERT INTO `academy`.`b_and_d_table`(`id_d`, `id_b`)VALUES ('3', '1');
INSERT INTO `academy`.`b_and_d_table`(`id_d`, `id_b`)VALUES ('4', '1');
INSERT INTO `academy`.`b_and_d_table`(`id_d`, `id_b`)VALUES ('1', '4');